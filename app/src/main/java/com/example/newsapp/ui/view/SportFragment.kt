...
class SportFragment : Fragment() {
    ...
    private fun setUpRecyclerView() = binding.apply {
        sportRecycler.layoutManager = LinearLayoutManager(requireContext())
        sportRecycler.adapter = NewsAdapter(requireContext())
    }
    ...
    private fun fillNewsData(apiResponse: NewsReponse) = binding.apply {
        (sportRecycler.adapter as NewsAdapter).setData(apiResponse.articles)
    }
